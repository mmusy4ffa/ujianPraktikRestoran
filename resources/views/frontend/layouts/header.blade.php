<nav class="navbar navbar-expand-lg navbar-dark osahan-nav">
    <div class="container">
       <a class="navbar-brand" href="{{route('index')}}"><img alt="logo" src="{{asset('frontend/img/favicon.png')}}"></a>
...
@endphp
             <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                    ...
                    <a class="dropdown-item" href="{{route ('user.logout')}}"><i class="icofont-sale-discount"></i> Log Out</a>
                    </div>
             </li>
