                       ...
                       @endif
                           ...
                           <form method="POST" action="{{ route('register') }}">
                            @csrf
                              ...
                              <div class="form-label-group">
                                 <input type="password" name="password_confirmation" id="inputPassword  1" class="form-control" placeholder="Password">
                                 <label for="inputPassword1">Confirm Passowrd</label>
                              </div>
